      ...
      def load_default_reader_regions
        OpenStruct.new.tap do |reader|
          reader.edit = Radiant::AdminUI::RegionSet.new do |edit|
            ...
            edit.form.concat %w{edit_name edit_email edit_nickname edit_password edit_dob edit_address edit_phone edit_description edit_notes}
            edit.form_additions.concat %w{reader_groups}
